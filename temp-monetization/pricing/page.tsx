        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-2xl p-8 border-4 border-indigo-500 relative">
            ...
            <button 
              ...
              disabled={loading}
              className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white py-4 px-6 rounded-lg font-bold text-lg transition-colors duration-200 flex items-center justify-center"
            >
              {loading ? (
              ...
              {loading ? 'Processing...' : 'Get Lifetime Access - $67'}
            </button>
